...
```bash
go get github.com/speakeasy-sdks/language-go
```
...
import (
	...
	"errors"
	languagego "github.com/speakeasy-sdks/language-go"
	"github.com/speakeasy-sdks/language-go/pkg/models/sdkerrors"
	"log"
)
...
func main() {
	s := languagego.New(
		languagego.WithServerURL("http://petstore.swagger.io/v1"),
	)
